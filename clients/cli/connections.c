...
cleanup_olpc:
		...
		gboolean success = FALSE;
		NMSettingIPTunnelMode mode_enum;
		...
		if (   !nm_utils_enum_from_str (nm_setting_ip_tunnel_mode_get_type (), mode, (int *) &mode_enum, NULL)
		    || mode_enum == NM_SETTING_IP_TUNNEL_MODE_UNKNOWN) {
			g_set_error (error, NMCLI_ERROR, NMC_RESULT_ERROR_USER_INPUT,
