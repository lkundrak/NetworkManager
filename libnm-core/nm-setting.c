...
/**
 * nm_setting_property_has_metadata:
 * @setting: the #NMSetting
 * @property_name: the name of the property
 *
 * Return whether property has metadata for @setting.@property_name.
 ...
 *
 * Returns: whether the property has meta-data
 *
 * Since: 1.2
 **/
gboolean
nm_setting_property_has_metadata (NMSetting *setting, const char *property_name)
{
	GParamSpec *pspec;
...
nm_setting_property_get_gtype (NMSetting *setting, const char *property_name)
{
	...
	if (!nm_setting_property_has_metadata (setting, property_name))
