...
#define NM_SETTING_TUN_USER                 "user"
#define NM_SETTING_TUN_GROUP                "group"
#define NM_SETTING_TUN_TAP                  "tap"
...
NM_AVAILABLE_IN_1_2
const char *nm_setting_tun_get_user         (NMSettingTun *setting);
NM_AVAILABLE_IN_1_2
const char *nm_setting_tun_get_group        (NMSettingTun *setting);
NM_AVAILABLE_IN_1_2
gboolean    nm_setting_tun_get_tap          (NMSettingTun *setting);
NM_AVAILABLE_IN_1_2
