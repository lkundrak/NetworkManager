...
#define NM_CONFIG_DATA_GLOBAL_DNS_GROUP      "global-dns"
#define NM_CONFIG_DATA_GLOBAL_DNS_DOMAIN_PREFIX  "global-dns-domain-"
...
typedef enum { /*< flags >*/
	...
	NM_CONFIG_CHANGE_GLOBAL_DNS_CONFIG         = (1L << 8),
