...
test_subtract (void)
{
	...
	nm_ip4_config_set_mtu (dst, expected_mtu, NM_PLATFORM_SOURCE_UNKNOWN);
...
test_merge_subtract_mss_mtu (void)
{
	...
	nm_ip4_config_set_mtu (cfg2, expected_mtu2, NM_PLATFORM_SOURCE_UNKNOWN);
	nm_ip4_config_set_mss (cfg3, expected_mss3);
	nm_ip4_config_set_mtu (cfg3, expected_mtu3, NM_PLATFORM_SOURCE_UNKNOWN);
