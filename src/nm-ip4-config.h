...
/* MTU */
void nm_ip4_config_set_mtu (NMIP4Config *config, guint32 mtu, NMPlatformSource source);
guint32 nm_ip4_config_get_mtu (const NMIP4Config *config);
NMPlatformSource nm_ip4_config_get_mtu_source (const NMIP4Config *config);
