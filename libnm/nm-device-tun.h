...
const char * nm_device_tun_get_user        (NMDeviceTun *device);
const char * nm_device_tun_get_group       (NMDeviceTun *device);
const char * nm_device_tun_get_mode        (NMDeviceTun *device);
gboolean     nm_device_tun_get_pi          (NMDeviceTun *device);
